...
const Person: FC = () => {
  ...
  return (
    <Page className="bg-pastel overflow-y-hidden relative flex flex-col ">
      <div className="overflow-y-scroll scrollbar-hide space-y-24 pb-2 flex flex-col">
        ...
        <main className="flex-grow bg-gradient-to-b from-blue-100/90 to-white/70 rounded-[2rem] flex flex-col items-center space-y-4 backdrop-blur-md ">
          ...
          <section className="flex flex-col w-full items-center space-y-2 flex-1  overflow-hidden">
            ...
            {/* Image-grid */}
            <main className="bg-white shadow-md w-full p-2 rounded-[2rem] flex-1">
